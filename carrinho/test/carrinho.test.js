...
describe("Testes do Carrinho", () => {
  ...
  it("Deve ter itens", () => {
    ...
    const carrinho = new Carrinho();
    carrinho.adiciona(item), carrinho.adiciona(item2);
  ...
  it("Deve lançar erro ao lançar finalizar compra com carrinho vazio", () => {
  ...
  it("Deve calcular o total da compra", () => {
    const item = new Item("Pera", 5, 3);
    const item2 = new Item("Chocolte", 1, 10);
